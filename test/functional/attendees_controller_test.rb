...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post :create, attendee: { bio: @attendee.bio, name: @attendee.name, twitter_handle: @attendee.twitter_handle }
    end
  ...
  test "should update attendee" do
    put :update, id: @attendee, attendee: { bio: @attendee.bio, name: @attendee.name, twitter_handle: @attendee.twitter_handle }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
